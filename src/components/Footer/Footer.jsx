    ...
    return(
        ...
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
            <img src={logo} alt="logo tailus" className="m-auto w-32" />
            <ul
              role="list"
              className="flex flex-col items-center justify-center gap-4 py-4 sm:flex-row sm:gap-8"
            >
              <li role="listitem"><a href="#" className="hover:text-primary">Accueil</a></li>
              <li role="listitem"><a href="#" className="hover:text-primary">A Propos</a></li>
              <li role="listitem"><a href="#" className="hover:text-primary">Nous Trouver</a></li>
              <li role="listitem"><a href="#" className="hover:text-primary">Contacts</a></li>
            </ul>
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide">
                Copyright © le BZ - 2023 | Tous droits reservés
              </span>
            </div>
          </div>
        </div>
